...
public class GetSensorR_TEMPHyperlink  implements java.io.Serializable {
    private java.lang.String IMEINO;

    private java.lang.String DTTYPE;

    public GetSensorR_TEMPHyperlink() {
    }
    ...
    /**
     * Gets the IMEINO value for this GetSensorR_TEMPHyperlink.
     * 
     * @return IMEINO
     */
    ...
    /**
     * Sets the IMEINO value for this GetSensorR_TEMPHyperlink.
     * 
     * @param IMEINO
     */
    ...
    /**
     * Gets the DTTYPE value for this GetSensorR_TEMPHyperlink.
     * 
     * @return DTTYPE
     */
    ...
    /**
     * Sets the DTTYPE value for this GetSensorR_TEMPHyperlink.
     * 
     * @param DTTYPE
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSensorR_TEMPHyperlink)) return false;
        GetSensorR_TEMPHyperlink other = (GetSensorR_TEMPHyperlink) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSensorR_TEMPHyperlink.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetSensorR_TEMPHyperlink"));
