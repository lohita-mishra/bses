...
<div class="card card-primary mb-2">
	...
	<div class="card-body">
		Connection Request <span class="font-weight-bold"><%=connectionRequest.getRequestNo() %></span> was deleted successfully!
	</div>
	<div class="card-footer">
		<button type="button" class="btn btn-primary btn-sm" id="ok-btn" value="OK">OK</button>
	</div>
</div>
<script>
