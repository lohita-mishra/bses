...
public class GetFaultTypesFromCatDetailResponse {
	...
	@XmlElement(name = "ID")
	private String subFaultCategoryID;

	public String getSubFaultCategoryID() {
		return subFaultCategoryID;
	}

	public void setSubFaultCategoryID(String subFaultCategoryID) {
		this.subFaultCategoryID = subFaultCategoryID;
	}
