...
public class BackGroundTestResponse  implements java.io.Serializable {
    private com.bses.sap.ws.BackGroundTestResponseBackGroundTestResult backGroundTestResult;

    public BackGroundTestResponse() {
    }

    public BackGroundTestResponse(
           com.bses.sap.ws.BackGroundTestResponseBackGroundTestResult backGroundTestResult) {
     ...
     */
    public com.bses.sap.ws.BackGroundTestResponseBackGroundTestResult getBackGroundTestResult() {
        return backGroundTestResult;
    }
     ...
     */
    public void setBackGroundTestResult(com.bses.sap.ws.BackGroundTestResponseBackGroundTestResult backGroundTestResult) {
        this.backGroundTestResult = backGroundTestResult;
    }
