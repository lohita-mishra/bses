...
public class ZBAPI_IVR_CREATESO_ISUResponse  implements java.io.Serializable {
    private com.bses.sap.ws.ZBAPI_IVR_CREATESO_ISUResponseZBAPI_IVR_CREATESO_ISUResult ZBAPI_IVR_CREATESO_ISUResult;

    public ZBAPI_IVR_CREATESO_ISUResponse() {
    }

    public ZBAPI_IVR_CREATESO_ISUResponse(
           com.bses.sap.ws.ZBAPI_IVR_CREATESO_ISUResponseZBAPI_IVR_CREATESO_ISUResult ZBAPI_IVR_CREATESO_ISUResult) {
     ...
     */
    public com.bses.sap.ws.ZBAPI_IVR_CREATESO_ISUResponseZBAPI_IVR_CREATESO_ISUResult getZBAPI_IVR_CREATESO_ISUResult() {
        return ZBAPI_IVR_CREATESO_ISUResult;
    }
     ...
     */
    public void setZBAPI_IVR_CREATESO_ISUResult(com.bses.sap.ws.ZBAPI_IVR_CREATESO_ISUResponseZBAPI_IVR_CREATESO_ISUResult ZBAPI_IVR_CREATESO_ISUResult) {
        this.ZBAPI_IVR_CREATESO_ISUResult = ZBAPI_IVR_CREATESO_ISUResult;
    }
