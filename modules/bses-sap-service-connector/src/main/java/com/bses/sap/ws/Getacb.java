...
public class Getacb  implements java.io.Serializable {
    ...
    /**
     * Gets the subsid value for this Getacb.
     * 
     * @return subsid
     */
    ...
    /**
     * Sets the subsid value for this Getacb.
     * 
     * @param subsid
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Getacb)) return false;
        Getacb other = (Getacb) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Getacb.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">getacb"));
