...
public class GetSubstationlistResponse  implements java.io.Serializable {
    private com.bses.sap.ws.GetSubstationlistResponseGetSubstationlistResult getSubstationlistResult;

    public GetSubstationlistResponse() {
    }

    public GetSubstationlistResponse(
           com.bses.sap.ws.GetSubstationlistResponseGetSubstationlistResult getSubstationlistResult) {
     ...
     */
    public com.bses.sap.ws.GetSubstationlistResponseGetSubstationlistResult getGetSubstationlistResult() {
        return getSubstationlistResult;
    }
     ...
     */
    public void setGetSubstationlistResult(com.bses.sap.ws.GetSubstationlistResponseGetSubstationlistResult getSubstationlistResult) {
        this.getSubstationlistResult = getSubstationlistResult;
    }
