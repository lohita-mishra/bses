...
public class ComplaintRegistrationWeb_AreaResponse  implements java.io.Serializable {
    private com.bses.sap.ws.ComplaintRegistrationWeb_AreaResponseComplaintRegistrationWeb_AreaResult complaintRegistrationWeb_AreaResult;

    public ComplaintRegistrationWeb_AreaResponse() {
    }

    public ComplaintRegistrationWeb_AreaResponse(
           com.bses.sap.ws.ComplaintRegistrationWeb_AreaResponseComplaintRegistrationWeb_AreaResult complaintRegistrationWeb_AreaResult) {
     ...
     */
    public com.bses.sap.ws.ComplaintRegistrationWeb_AreaResponseComplaintRegistrationWeb_AreaResult getComplaintRegistrationWeb_AreaResult() {
        return complaintRegistrationWeb_AreaResult;
    }
     ...
     */
    public void setComplaintRegistrationWeb_AreaResult(com.bses.sap.ws.ComplaintRegistrationWeb_AreaResponseComplaintRegistrationWeb_AreaResult complaintRegistrationWeb_AreaResult) {
        this.complaintRegistrationWeb_AreaResult = complaintRegistrationWeb_AreaResult;
    }
