...
public class UpdateComplaintResolutiontimeResponse  implements java.io.Serializable {
    private com.bses.sap.ws.UpdateComplaintResolutiontimeResponseUpdateComplaintResolutiontimeResult updateComplaintResolutiontimeResult;

    public UpdateComplaintResolutiontimeResponse() {
    }

    public UpdateComplaintResolutiontimeResponse(
           com.bses.sap.ws.UpdateComplaintResolutiontimeResponseUpdateComplaintResolutiontimeResult updateComplaintResolutiontimeResult) {
     ...
     */
    public com.bses.sap.ws.UpdateComplaintResolutiontimeResponseUpdateComplaintResolutiontimeResult getUpdateComplaintResolutiontimeResult() {
        return updateComplaintResolutiontimeResult;
    }
     ...
     */
    public void setUpdateComplaintResolutiontimeResult(com.bses.sap.ws.UpdateComplaintResolutiontimeResponseUpdateComplaintResolutiontimeResult updateComplaintResolutiontimeResult) {
        this.updateComplaintResolutiontimeResult = updateComplaintResolutiontimeResult;
    }
