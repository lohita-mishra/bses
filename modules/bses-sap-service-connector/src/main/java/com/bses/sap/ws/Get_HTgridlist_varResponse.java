...
public class Get_HTgridlist_varResponse  implements java.io.Serializable {
    private com.bses.sap.ws.Get_HTgridlist_varResponseGet_HTgridlist_varResult get_HTgridlist_varResult;

    public Get_HTgridlist_varResponse() {
    }

    public Get_HTgridlist_varResponse(
           com.bses.sap.ws.Get_HTgridlist_varResponseGet_HTgridlist_varResult get_HTgridlist_varResult) {
     ...
     */
    public com.bses.sap.ws.Get_HTgridlist_varResponseGet_HTgridlist_varResult getGet_HTgridlist_varResult() {
        return get_HTgridlist_varResult;
    }
     ...
     */
    public void setGet_HTgridlist_varResult(com.bses.sap.ws.Get_HTgridlist_varResponseGet_HTgridlist_varResult get_HTgridlist_varResult) {
        this.get_HTgridlist_varResult = get_HTgridlist_varResult;
    }
