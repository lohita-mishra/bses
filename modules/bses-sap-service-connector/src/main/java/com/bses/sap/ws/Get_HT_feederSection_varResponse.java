...
public class Get_HT_feederSection_varResponse  implements java.io.Serializable {
    private com.bses.sap.ws.Get_HT_feederSection_varResponseGet_HT_feederSection_varResult get_HT_feederSection_varResult;

    public Get_HT_feederSection_varResponse() {
    }

    public Get_HT_feederSection_varResponse(
           com.bses.sap.ws.Get_HT_feederSection_varResponseGet_HT_feederSection_varResult get_HT_feederSection_varResult) {
     ...
     */
    public com.bses.sap.ws.Get_HT_feederSection_varResponseGet_HT_feederSection_varResult getGet_HT_feederSection_varResult() {
        return get_HT_feederSection_varResult;
    }
     ...
     */
    public void setGet_HT_feederSection_varResult(com.bses.sap.ws.Get_HT_feederSection_varResponseGet_HT_feederSection_varResult get_HT_feederSection_varResult) {
        this.get_HT_feederSection_varResult = get_HT_feederSection_varResult;
    }
