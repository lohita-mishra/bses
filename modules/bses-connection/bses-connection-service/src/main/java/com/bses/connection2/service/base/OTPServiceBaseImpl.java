...
import com.bses.connection2.service.OTPService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.bses.connection2.service.impl.OTPServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.bses.connection2.service.impl.OTPServiceImpl
 * @generated
 */
public abstract class OTPServiceBaseImpl
	extends BaseServiceImpl implements IdentifiableOSGiService, OTPService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OTPService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>OTPServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(otpService);
	}
	...
	private void _setServiceUtilService(OTPService otpService) {
		try {
			Field field = OTPServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, otpService);
		}
	...
	@BeanReference(type = OTPService.class)
