...
public class Get_BD_DetailsResponse  implements java.io.Serializable {
    private com.bses.sap.ws.Get_BD_DetailsResponseGet_BD_DetailsResult get_BD_DetailsResult;

    public Get_BD_DetailsResponse() {
    }

    public Get_BD_DetailsResponse(
           com.bses.sap.ws.Get_BD_DetailsResponseGet_BD_DetailsResult get_BD_DetailsResult) {
     ...
     */
    public com.bses.sap.ws.Get_BD_DetailsResponseGet_BD_DetailsResult getGet_BD_DetailsResult() {
        return get_BD_DetailsResult;
    }
     ...
     */
    public void setGet_BD_DetailsResult(com.bses.sap.ws.Get_BD_DetailsResponseGet_BD_DetailsResult get_BD_DetailsResult) {
        this.get_BD_DetailsResult = get_BD_DetailsResult;
    }
