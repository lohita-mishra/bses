...
/**
 * Provides the remote service interface for LocalityDivision. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see LocalityDivisionServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
@OSGiBeanProperties(
	property = {
		...
		"json.web.service.context.path=LocalityDivision"
	},
	service = LocalityDivisionService.class
)
@ProviderType
@Transactional(
...
public interface LocalityDivisionService extends BaseService {
