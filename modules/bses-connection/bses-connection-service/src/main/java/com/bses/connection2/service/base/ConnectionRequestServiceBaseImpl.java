...
import com.bses.connection2.service.ConnectionRequestService;
...
/**
 * Provides the base implementation for the connection request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.bses.connection2.service.impl.ConnectionRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.bses.connection2.service.impl.ConnectionRequestServiceImpl
 * @generated
 */
public abstract class ConnectionRequestServiceBaseImpl
	extends BaseServiceImpl
	implements ConnectionRequestService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ConnectionRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ConnectionRequestServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(connectionRequestService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ConnectionRequestService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ConnectionRequestServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, connectionRequestService);
		}
	...
	@BeanReference(type = ConnectionRequestService.class)
