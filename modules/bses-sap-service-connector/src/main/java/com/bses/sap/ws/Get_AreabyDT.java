...
public class Get_AreabyDT  implements java.io.Serializable {
    ...
    /**
     * Gets the polestr value for this Get_AreabyDT.
     * 
     * @return polestr
     */
    ...
    /**
     * Sets the polestr value for this Get_AreabyDT.
     * 
     * @param polestr
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Get_AreabyDT)) return false;
        Get_AreabyDT other = (Get_AreabyDT) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Get_AreabyDT.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">Get_AreabyDT"));
