...
public class Get_BD_MISResponse  implements java.io.Serializable {
    private com.bses.sap.ws.Get_BD_MISResponseGet_BD_MISResult get_BD_MISResult;

    public Get_BD_MISResponse() {
    }

    public Get_BD_MISResponse(
           com.bses.sap.ws.Get_BD_MISResponseGet_BD_MISResult get_BD_MISResult) {
     ...
     */
    public com.bses.sap.ws.Get_BD_MISResponseGet_BD_MISResult getGet_BD_MISResult() {
        return get_BD_MISResult;
    }
     ...
     */
    public void setGet_BD_MISResult(com.bses.sap.ws.Get_BD_MISResponseGet_BD_MISResult get_BD_MISResult) {
        this.get_BD_MISResult = get_BD_MISResult;
    }
