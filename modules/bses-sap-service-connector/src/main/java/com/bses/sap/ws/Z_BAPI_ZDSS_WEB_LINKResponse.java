...
public class Z_BAPI_ZDSS_WEB_LINKResponse  implements java.io.Serializable {
    private com.bses.sap.ws.Z_BAPI_ZDSS_WEB_LINKResponseZ_BAPI_ZDSS_WEB_LINKResult z_BAPI_ZDSS_WEB_LINKResult;

    public Z_BAPI_ZDSS_WEB_LINKResponse() {
    }

    public Z_BAPI_ZDSS_WEB_LINKResponse(
           com.bses.sap.ws.Z_BAPI_ZDSS_WEB_LINKResponseZ_BAPI_ZDSS_WEB_LINKResult z_BAPI_ZDSS_WEB_LINKResult) {
     ...
     */
    public com.bses.sap.ws.Z_BAPI_ZDSS_WEB_LINKResponseZ_BAPI_ZDSS_WEB_LINKResult getZ_BAPI_ZDSS_WEB_LINKResult() {
        return z_BAPI_ZDSS_WEB_LINKResult;
    }
     ...
     */
    public void setZ_BAPI_ZDSS_WEB_LINKResult(com.bses.sap.ws.Z_BAPI_ZDSS_WEB_LINKResponseZ_BAPI_ZDSS_WEB_LINKResult z_BAPI_ZDSS_WEB_LINKResult) {
        this.z_BAPI_ZDSS_WEB_LINKResult = z_BAPI_ZDSS_WEB_LINKResult;
    }
