...
public class Get_dtlist  implements java.io.Serializable {
    ...
    /**
     * Gets the SAPFUNCTIO value for this Get_dtlist.
     * 
     * @return SAPFUNCTIO
     */
    ...
    /**
     * Sets the SAPFUNCTIO value for this Get_dtlist.
     * 
     * @param SAPFUNCTIO
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Get_dtlist)) return false;
        Get_dtlist other = (Get_dtlist) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Get_dtlist.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">Get_dtlist"));
