/**
 * GetSensorOIL_TEMPHyperlink.java
 *
...
public class GetSensorOIL_TEMPHyperlink  implements java.io.Serializable {
    private java.lang.String IMEINO;

    private java.lang.String DTTYPE;

    public GetSensorOIL_TEMPHyperlink() {
    }
    ...
    /**
     * Gets the IMEINO value for this GetSensorOIL_TEMPHyperlink.
     * 
     * @return IMEINO
     */
    ...
    /**
     * Sets the IMEINO value for this GetSensorOIL_TEMPHyperlink.
     * 
     * @param IMEINO
     */
    ...
    /**
     * Gets the DTTYPE value for this GetSensorOIL_TEMPHyperlink.
     * 
     * @return DTTYPE
     */
    ...
    /**
     * Sets the DTTYPE value for this GetSensorOIL_TEMPHyperlink.
     * 
     * @param DTTYPE
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSensorOIL_TEMPHyperlink)) return false;
        GetSensorOIL_TEMPHyperlink other = (GetSensorOIL_TEMPHyperlink) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSensorOIL_TEMPHyperlink.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetSensorOIL_TEMPHyperlink"));
