...
public class Get_Area_Details_forconstituencyResponse  implements java.io.Serializable {
    private com.bses.sap.ws.Get_Area_Details_forconstituencyResponseGet_Area_Details_forconstituencyResult get_Area_Details_forconstituencyResult;

    public Get_Area_Details_forconstituencyResponse() {
    }

    public Get_Area_Details_forconstituencyResponse(
           com.bses.sap.ws.Get_Area_Details_forconstituencyResponseGet_Area_Details_forconstituencyResult get_Area_Details_forconstituencyResult) {
     ...
     */
    public com.bses.sap.ws.Get_Area_Details_forconstituencyResponseGet_Area_Details_forconstituencyResult getGet_Area_Details_forconstituencyResult() {
        return get_Area_Details_forconstituencyResult;
    }
     ...
     */
    public void setGet_Area_Details_forconstituencyResult(com.bses.sap.ws.Get_Area_Details_forconstituencyResponseGet_Area_Details_forconstituencyResult get_Area_Details_forconstituencyResult) {
        this.get_Area_Details_forconstituencyResult = get_Area_Details_forconstituencyResult;
    }
