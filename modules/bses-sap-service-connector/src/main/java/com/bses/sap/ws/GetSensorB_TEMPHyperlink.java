...
public class GetSensorB_TEMPHyperlink  implements java.io.Serializable {
    private java.lang.String IMEINO;

    private java.lang.String DTTYPE;

    public GetSensorB_TEMPHyperlink() {
    }
    ...
    /**
     * Gets the IMEINO value for this GetSensorB_TEMPHyperlink.
     * 
     * @return IMEINO
     */
    ...
    /**
     * Sets the IMEINO value for this GetSensorB_TEMPHyperlink.
     * 
     * @param IMEINO
     */
    ...
    /**
     * Gets the DTTYPE value for this GetSensorB_TEMPHyperlink.
     * 
     * @return DTTYPE
     */
    ...
    /**
     * Sets the DTTYPE value for this GetSensorB_TEMPHyperlink.
     * 
     * @param DTTYPE
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSensorB_TEMPHyperlink)) return false;
        GetSensorB_TEMPHyperlink other = (GetSensorB_TEMPHyperlink) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSensorB_TEMPHyperlink.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetSensorB_TEMPHyperlink"));
