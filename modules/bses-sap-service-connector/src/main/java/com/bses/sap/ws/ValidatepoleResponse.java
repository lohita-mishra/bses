...
public class ValidatepoleResponse  implements java.io.Serializable {
    private com.bses.sap.ws.ValidatepoleResponseValidatepoleResult validatepoleResult;

    public ValidatepoleResponse() {
    }

    public ValidatepoleResponse(
           com.bses.sap.ws.ValidatepoleResponseValidatepoleResult validatepoleResult) {
     ...
     */
    public com.bses.sap.ws.ValidatepoleResponseValidatepoleResult getValidatepoleResult() {
        return validatepoleResult;
    }
     ...
     */
    public void setValidatepoleResult(com.bses.sap.ws.ValidatepoleResponseValidatepoleResult validatepoleResult) {
        this.validatepoleResult = validatepoleResult;
    }
