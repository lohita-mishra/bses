...
public class Get_FDRNames  implements java.io.Serializable {
    ...
    /**
     * Gets the ltfdrcd value for this Get_FDRNames.
     * 
     * @return ltfdrcd
     */
    ...
    /**
     * Sets the ltfdrcd value for this Get_FDRNames.
     * 
     * @param ltfdrcd
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Get_FDRNames)) return false;
        Get_FDRNames other = (Get_FDRNames) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Get_FDRNames.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">Get_FDRNames"));
