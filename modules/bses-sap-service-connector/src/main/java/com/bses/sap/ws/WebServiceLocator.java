...
public class WebServiceLocator extends org.apache.axis.client.Service implements com.bses.sap.ws.WebService {
...
//    private java.lang.String WebServiceSoap_address = "";
    ...
    public com.bses.sap.ws.WebServiceSoap getWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.bses.sap.ws.WebServiceSoap getWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bses.sap.ws.WebServiceSoapStub _stub = new com.bses.sap.ws.WebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bses.sap.ws.WebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bses.sap.ws.WebServiceSoapStub _stub = new com.bses.sap.ws.WebServiceSoapStub(new java.net.URL(WebServiceSoap_address), this);
                _stub.setPortName(getWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
