...
public class Get_Division_detailsResponse  implements java.io.Serializable {
    private com.bses.sap.ws.Get_Division_detailsResponseGet_Division_detailsResult get_Division_detailsResult;

    public Get_Division_detailsResponse() {
    }

    public Get_Division_detailsResponse(
           com.bses.sap.ws.Get_Division_detailsResponseGet_Division_detailsResult get_Division_detailsResult) {
     ...
     */
    public com.bses.sap.ws.Get_Division_detailsResponseGet_Division_detailsResult getGet_Division_detailsResult() {
        return get_Division_detailsResult;
    }
     ...
     */
    public void setGet_Division_detailsResult(com.bses.sap.ws.Get_Division_detailsResponseGet_Division_detailsResult get_Division_detailsResult) {
        this.get_Division_detailsResult = get_Division_detailsResult;
    }
