...
public class GetrmuResponse  implements java.io.Serializable {
    private com.bses.sap.ws.GetrmuResponseGetrmuResult getrmuResult;

    public GetrmuResponse() {
    }

    public GetrmuResponse(
           com.bses.sap.ws.GetrmuResponseGetrmuResult getrmuResult) {
     ...
     * @return getrmuResult
     */
    public com.bses.sap.ws.GetrmuResponseGetrmuResult getGetrmuResult() {
        return getrmuResult;
    }
     ...
     * @param getrmuResult
     */
    public void setGetrmuResult(com.bses.sap.ws.GetrmuResponseGetrmuResult getrmuResult) {
        this.getrmuResult = getrmuResult;
    }
