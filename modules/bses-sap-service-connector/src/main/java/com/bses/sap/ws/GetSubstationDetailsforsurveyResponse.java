...
public class GetSubstationDetailsforsurveyResponse  implements java.io.Serializable {
    private com.bses.sap.ws.GetSubstationDetailsforsurveyResponseGetSubstationDetailsforsurveyResult getSubstationDetailsforsurveyResult;

    public GetSubstationDetailsforsurveyResponse() {
    }

    public GetSubstationDetailsforsurveyResponse(
           com.bses.sap.ws.GetSubstationDetailsforsurveyResponseGetSubstationDetailsforsurveyResult getSubstationDetailsforsurveyResult) {
     ...
     */
    public com.bses.sap.ws.GetSubstationDetailsforsurveyResponseGetSubstationDetailsforsurveyResult getGetSubstationDetailsforsurveyResult() {
        return getSubstationDetailsforsurveyResult;
    }
     ...
     */
    public void setGetSubstationDetailsforsurveyResult(com.bses.sap.ws.GetSubstationDetailsforsurveyResponseGetSubstationDetailsforsurveyResult getSubstationDetailsforsurveyResult) {
        this.getSubstationDetailsforsurveyResult = getSubstationDetailsforsurveyResult;
    }
