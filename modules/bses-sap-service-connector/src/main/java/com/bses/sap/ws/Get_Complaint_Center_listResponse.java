...
public class Get_Complaint_Center_listResponse  implements java.io.Serializable {
    private com.bses.sap.ws.Get_Complaint_Center_listResponseGet_Complaint_Center_listResult get_Complaint_Center_listResult;

    public Get_Complaint_Center_listResponse() {
    }

    public Get_Complaint_Center_listResponse(
           com.bses.sap.ws.Get_Complaint_Center_listResponseGet_Complaint_Center_listResult get_Complaint_Center_listResult) {
     ...
     */
    public com.bses.sap.ws.Get_Complaint_Center_listResponseGet_Complaint_Center_listResult getGet_Complaint_Center_listResult() {
        return get_Complaint_Center_listResult;
    }
     ...
     */
    public void setGet_Complaint_Center_listResult(com.bses.sap.ws.Get_Complaint_Center_listResponseGet_Complaint_Center_listResult get_Complaint_Center_listResult) {
        this.get_Complaint_Center_listResult = get_Complaint_Center_listResult;
    }
